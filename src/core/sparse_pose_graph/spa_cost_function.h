...
#ifndef SAMPLE_CARTO_CORE_SPARSE_POSE_GRAPH_SPA_COST_FUNCTION_H_
#define SAMPLE_CARTO_CORE_SPARSE_POSE_GRAPH_SPA_COST_FUNCTION_H_
...
#endif  // SAMPLE_CARTO_CORE_SPARSE_POSE_GRAPH_SPA_COST_FUNCTION_H_
