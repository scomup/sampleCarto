...
#ifndef SAMPLE_CARTO_CORE_SCAN_MATCHING_CORRELATIVE_SCAN_MATCHER_H_
#define SAMPLE_CARTO_CORE_SCAN_MATCHING_CORRELATIVE_SCAN_MATCHER_H_
...
struct SearchParameters {
  ...
  void ShrinkToFit(const std::vector<DiscreteScan>& scans,
                   const map::CellLimits& cell_limits);
...
std::vector<DiscreteScan> DiscretizeScans(
    const map::MapLimits& map_limits, const std::vector<sensor::PointCloud>& scans,
...
#endif  // SAMPLE_CARTO_CORE_SCAN_MATCHING_CORRELATIVE_SCAN_MATCHER_H_
