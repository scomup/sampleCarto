...
#ifndef SAMPLE_CARTO_CORE_SCAN_MATCHING_TRANSLATION_DELTA_COST_FUNCTOR_H_
#define SAMPLE_CARTO_CORE_SCAN_MATCHING_TRANSLATION_DELTA_COST_FUNCTOR_H_
...
#endif  // SAMPLE_CARTO_CORE_SCAN_MATCHING_TRANSLATION_DELTA_COST_FUNCTOR_H_
