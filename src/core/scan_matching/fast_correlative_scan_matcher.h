...
#ifndef SAMPLE_CARTO_CORE_SCAN_MATCHING_FAST_CORRELATIVE_SCAN_MATCHER_H_
#define SAMPLE_CARTO_CORE_SCAN_MATCHING_FAST_CORRELATIVE_SCAN_MATCHER_H_
...
{
  public:
    PrecomputationGrid(const map::ProbabilityGrid &probability_grid,
                       const map::CellLimits &limits, int width,
  ...
  private:
    ...
    const map::CellLimits wide_limits_;
...
class FastCorrelativeScanMatcher
{
  ...
  private:
    ...
    const FastCorrelativeScanMatcherOptions options_;
    map::MapLimits limits_;
...
#endif // SAMPLE_CARTO_CORE_SCAN_MATCHING_FAST_CORRELATIVE_SCAN_MATCHER_H_
