...
#ifndef SAMPLE_CARTO_COMMON_CONFIGURATION_FILE_RESOLVER_H_
#define SAMPLE_CARTO_COMMON_CONFIGURATION_FILE_RESOLVER_H_
...
class FileResolver {
 public:
  explicit FileResolver(
      const std::vector<string>& configuration_files_directories);

  string GetFullPathOrDie(const string& basename);
  string GetFileContentOrDie(const string& basename);
...
#endif  // SAMPLE_CARTO_COMMON_CONFIGURATION_FILE_RESOLVER_H_
