...
#ifndef SAMPLE_CARTO_COMMON_LUA_PARAMETER_DICTIONARY_H_
#define SAMPLE_CARTO_COMMON_LUA_PARAMETER_DICTIONARY_H_
...
#endif  // SAMPLE_CARTO_COMMON_LUA_PARAMETER_DICTIONARY_H_
