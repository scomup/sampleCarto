...
#ifndef SAMPLE_CARTO_TRANSFORM_RIGID_TRANSFORM_H_
#define SAMPLE_CARTO_TRANSFORM_RIGID_TRANSFORM_H_
...
std::ostream& operator<<(std::ostream& os,
                         const sample_carto::transform::Rigid2<T>& rigid) {
...
template <typename T>
std::ostream& operator<<(std::ostream& os,
                         const sample_carto::transform::Rigid3<T>& rigid) {
  os << rigid.DebugString();
  return os;
}
...
#endif  // SAMPLE_CARTO_TRANSFORM_RIGID_TRANSFORM_H_
